...
$urls = array(
		...
		array(
				'url'=>array(
						...
						array('url'=>$this->createWebUrl('upgate'),'title'=>'授权升级','icon'=>'fa fa-cog','issys'=>true),
						array('url'=>$this->createWebUrl('sysset'),'title'=>'pc端版权设置','icon'=>'fa fa-cog','issys'=>true),
						array('url'=>$this->createWebUrl('help'),'title'=>'帮助手册','icon'=>'fa fa-cog','issys'=>true),
						array('url'=>$this->createWebUrl('help_contect'),'title'=>'联系我们','icon'=>'fa fa-cog','issys'=>true),
				),
				'head'=>' 系统设置',
				'icon'=>'fa fa-plane'
		),
		...
		array(
				'url'=>array(
						array('url'=>$this->createWebUrl('oneclear',array('op'=>'adv')),'title'=>'清理广告','icon'=>'fa fa fa-bomb'),
						array('url'=>$this->createWebUrl('oneclear',array('op'=>'topics')),'title'=>'清理帖子','icon'=>'fa fa fa-bomb'),
						array('url'=>$this->createWebUrl('oneclear',array('op'=>'threadclass')),'title'=>'清理分类','icon'=>'fa fa fa-bomb'),
						array('url'=>$this->createWebUrl('oneclear',array('op'=>'task')),'title'=>'清理任务大厅','icon'=>'fa fa fa-bomb'),
						array('url'=>$this->createWebUrl('oneclear',array('op'=>'other')),'title'=>'清理其他','icon'=>'fa fa fa-bomb'),
						array('url'=>$this->createWebUrl('oneclear',array('op'=>'all')),'title'=>'清理所有','icon'=>'fa fa fa-bomb'),
				),
				'head'=>' 清理数据',
				'icon'=>'fa fa-plane'
		),
