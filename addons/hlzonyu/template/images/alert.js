...
document.writeln("}");
document.writeln(".windoalert .titlealert {");
document.writeln("	");
...
document.writeln("	");
document.writeln("}");
document.writeln(".windoalert .contentalert {");
...
document.writeln("}");
document.writeln(".windoalert #txt {");
document.writeln("	min-height:30px;font-size:16px; line-height:22px;");
document.writeln("}");
document.writeln(".windoalert .txtbtn {");
document.writeln("	");
...
document.writeln("}");
document.writeln(".windoalert .txtbtn:visited {");
...
document.writeln("}");
document.writeln(".windoalert .txtbtn:hover {");
document.writeln("	background-image: -webkit-gradient(linear, left top, left bottom, from( #ffffff ), to( #cccccc )); \/* Saf4+, Chrome *\/");
document.writeln("	background-image: -webkit-linear-gradient( #ffffff , #cccccc ); \/* Chrome 10+, Saf5.1+ *\/");
document.writeln("	background-image:    -moz-linear-gradient( #ffffff , #cccccc ); \/* FF3.6 *\/");
document.writeln("	background-image:     -ms-linear-gradient( #ffffff , #cccccc ); \/* IE10 *\/");
...
document.writeln("	background-image:         linear-gradient( #ffffff , #cccccc );");
document.writeln("}");
document.writeln(".windoalert .txtbtn:active {");
...
document.writeln("}");
document.writeln("");
document.writeln(".windoalert .titlealert .close {");
...
document.writeln("<div class=\"windoalert\" id=\"windowcenter\">");
document.writeln("	<div id=\"titlealert\" class=\"titlealert\">消息提醒<span class=\"close\" id=\"alertclose\"><\/span><\/div>");
document.writeln("	<div class=\"contentalert\">");
