Main.flyLine = function(angle){
	...
	function initFlyLine() {  
		...
		flyRad = angleToRad(angle);
		 var flyData = {
			 images: ["../addons/wdl_daqie/template/mobile/img/fly.png"],
	...
	function addLongTrace(xPass, dif, timeC){
		longTracer = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/longtraces.png"));
	...
	function addTrace(dif){
		var totalD = 0;
		var tracer = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/traces.png"));
