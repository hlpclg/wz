...
;~function(bt){
	...
	bt.URL = {
		root: "http://v2.addons.012wz.com/web/index.php?c=store&a=author&uid=91001"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://v2.addons.012wz.com/web/index.php?c=store&a=author&uid=91001";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MjM5ODQzODk0MA==&mid=200754961&idx=1&sn=343f5c361ad670bc05f6bc683da7a153#rd";
		}
...
;~function(bt){
	...
	var loading = function(rate, error){
		if(rate > 0 && !loadingDiv){
			...
			loadingDiv.html('<table><tr><td><img class="bt-img" src="../addons/wdl_daqie/template/mobile/img/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
;~function(bt){
	...
	onlyH.prototype = {
		...
		,getScreenOption: function(){
			return {
				id: "bt-h-scrren"
				,html: "<table><tr><td><img class='bt-h-screen-img' src='../addons/wdl_daqie/template/mobile/img/bt-play-h-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
	...
	onlyV.prototype = $.extend({}, onlyH.prototype, {
		...
		,getScreenOption: function(){
			return {
				id: "bt-v-scrren"
				,html: "<table><tr><td><img class='bt-v-screen-img' src='../addons/wdl_daqie/template/mobile/img/bt-play-v-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
...
;~function(bt){
	...
	function tip(){
		var a = bt.advertisement({
			id: id
			,html: "<img class='bt-play-share-tip-img' src='../addons/wdl_daqie/template/mobile/img/bt-play-share-tip.png' />"
			,time: 0
		});
		a.show();
...
;~function(bt){
	...
	var dataForWeixin={
	   // appId:bt.URL.appId,
	   width:"66",
	   src: "../addons/wdl_daqie/template/mobile/img/icon.png",
