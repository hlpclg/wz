...
;~function(res){
	...
	res.load = function(){
		...
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/start.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/morebtn.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/startbtn.png");
		
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/penguin.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/bear.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/hill.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/guide.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/background1.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/background2.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/flyend.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/traces.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/longtraces.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/score.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/fly.png");
		
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/end.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/againbtn.png");
		res.queue.loadFile("../addons/wdl_daqie/template/mobile/img/notifybtn.png");
	}
...
Main.startGame = function(){
	...
	container.addChild(new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/start.png")));
	
	
	// 开始游戏
	var beginGame = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/startbtn.png"));
	...
	// 更多游戏
	var moreGame = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/morebtn.png"));
...
Main.endGame = function(distance){
	...
	container.addChild(new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/end.png")));
	...
	// 再来一次
	var again = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/againbtn.png"));
	...
	// 通知好友
	var notify = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/notifybtn.png"));
...
Main.initGame = function(){
	...
	var b1 = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/background2.png"));
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/background2.png"));
	b1.x = Main.width;
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/background1.png"));
	b1.x = Main.width * 2;
	img.addChild(b1);
	...
	Main.log("初始化：北极熊");
	var bearImg = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/bear.png"));
	...
	var bearSS = new createjs.SpriteSheet({
		...
		"images": [Resource.get("../addons/wdl_daqie/template/mobile/img/bear.png")],
		"frames":{
			"height": 360,
			"width":300,
			"regX": 0,
	...
	// 路标
	Main.log("初始化:路标");
	var guideBackground = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/guide.png"));
	...
	Main.log("初始化：企鹅");
	var penguinImg = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/penguin.png"));
	...
	var penguinSS = new createjs.SpriteSheet({
		...
		,"images" : [Resource.get("../addons/wdl_daqie/template/mobile/img/penguin.png")]
		,"frames" : {
			width: 180,
			height: 170,
			count: 6
	...
	var endData = {
		images: [Resource.get("../addons/wdl_daqie/template/mobile/img/flyend.png")],
	...
	Main.gameOverScoreBg = new createjs.Bitmap(Resource.get("../addons/wdl_daqie/template/mobile/img/score.png"));
