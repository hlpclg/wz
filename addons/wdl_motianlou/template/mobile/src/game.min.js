...
x.so = function(a) {
	if (this.Lf()) {
		...
		if (b) return b;
		a = cc.loader.Al("../addons/wdl_motianlou/template/mobile/res/conf/" + a + ".json")
		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://bbs.012wz.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://bbs.012wz.com";
y.url = function() {
	return "http://bbs.012wz.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://bbs.012wz.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("微信游戏—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c = {
	font: "黑体",
	Kj: ["../../addons/wdl_motianlou/template/mobile/res/texture.png", "../../addons/wdl_motianlou/template/mobile/res/texture.plist", "../../addons/wdl_motianlou/template/mobile/res/mtl_lifepad.png", "../../addons/wdl_motianlou/template/mobile/res/mtl_bg.jpg"],
	Nf: 0,
	Rf: 1
};
...
y.c.init = function() {
	x.init();
	cc.spriteFrameCache.addSpriteFrames("../../addons/wdl_motianlou/template/mobile/res/texture.plist");
	cc.textureCache.addImage("../../addons/wdl_motianlou/template/mobile/res/mtl_link.png");
	A.ck();
	y.c = _(y.c).extend({
		bl: h,
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("微信游戏", "Arial", 12);
		...
		a = new cc.Sprite("../../addons/wdl_motianlou/template/mobile/res/mtl_lifepad.png");
		this.addChild(a);
		this.Gb = y.c.Ag;
...
y.c.da = function(a) {
	x.ue.l().da(y.c.cb("../../addons/wdl_motianlou/template/mobile/res/sound/" + a + ".mp3"))
};
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://bbs.012wz.com"
			}, this);
