...
bs.jsonFromConfFile = function(d) {
	if (this.isInBrowser()) {
		...
		d = cc.loader._loadTxtSync("../addons/wdl_mazouri/template/mobile/res/conf/" + d + ".json")
	} else {
...
wx.chess = {
	designHeight: 533,
	font: "\u9ed1\u4f53",
	moreGamesUrl: "http://bbs.012wz.com/",
	resources: ["../addons/wdl_mazouri/template/mobile/res/texture.png", "../../addons/wdl_mazouri/template/mobile/res/texture.plist", "../addons/wdl_mazouri/template/mobile/res/step.mp3"],
	gridSize: {
		width: 64,
		height: 64
	},
...
wx.init = function() {
	bs.init();
	cc.spriteFrameCache.addSpriteFrames("../../addons/wdl_mazouri/template/mobile/res/texture.plist")
};
