...
function oddbullet(X,Y){
    ...
    bullet.call(this,X,Y,6,14,"../addons/zzplane_hhy/ui/image/bullet1.png");
...
function ourplan(X,Y){
    ...
    var imagesrc="../addons/zzplane_hhy/ui/image/my_plane.png";

    plan.call(this,1,X,Y,80,67,0,660,0,"../addons/zzplane_hhy/ui/image/plane_boom.gif",imagesrc);
...
function start(){
    ...
    if(mark==20){
        ...
        if(mark1%5==0){
            ...
            enemys.push(new enemy(6,25,274,75,49,5000,360,random(1,3),"../addons/zzplane_hhy/ui/image/big_boom.gif","http://open.weibiaozhi.com/ui/image/enemy3_fly_1.png"));
        ...
        if(mark1==20){
            ...
            enemys.push(new enemy(12,57,210,110,163,30000,540,1,"../addons/zzplane_hhy/ui/image/md_boom.gif","http://open.weibiaozhi.com/ui/image/enemy2_fly_1.png"));
        ...
        //小飞机
            ...
            enemys.push(new enemy(1,19,286,38,24,1000,360,random(1,4),"../addons/zzplane_hhy/ui/image/small_boom.gif","http://open.weibiaozhi.com/ui/image/enemy1_fly_1.png"));
            ...
            if(enemys[j].planisdie==false){
                ...
                if(enemys[j].imagenode.offsetLeft+enemys[j].plansizeX>=selfplan.imagenode.offsetLeft&&enemys[j].imagenode.offsetLeft<=selfplan.imagenode.offsetLeft+selfplan.plansizeX){
                  ...
                  if(enemys[j].imagenode.offsetTop+enemys[j].plansizeY>=selfplan.imagenode.offsetTop+40&&enemys[j].imagenode.offsetTop<=selfplan.imagenode.offsetTop-20+selfplan.plansizeY){
                      ...
                      selfplan.imagenode.src="../addons/zzplane_hhy/ui/image/plane_boom.gif";
