...
~function(bt) {
    ...
    var loading = function(d, e) {
        if (d > 0 && !b) {
            ...
            b.html('<table><tr><td><img class="bt-img" src="../addons/wdl_daoguo/template/mobile/resource/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
~function(bt) {
    ...
    onlyH.prototype = {
        ...
        getScreenOption: function() {
            return {
                id: "bt-h-scrren",
                html: "<table><tr><td><img class='bt-h-screen-img' src='../addons/wdl_daoguo/template/mobile/resource//bt-play-h-screen.png' /></td></tr></table>",
                time: 0,
                lockId: "bt-hide-lock"
            };
        },
    ...
    onlyV.prototype = $.extend({}, onlyH.prototype, {
        ...
        getScreenOption: function() {
            return {
                id: "bt-v-scrren",
                html: "<table><tr><td><img class='bt-v-screen-img' src='../addons/wdl_daoguo/template/mobile/resource/bt-play-v-screen.png' /></td></tr></table>",
                time: 0,
                lockId: "bt-hide-lock"
            };
        }
...
~function(bt) {
    ...
    function tip() {
        var c = bt.advertisement({
            id: b,
            html: "<img class='bt-play-share-tip-img' src='../addons/wdl_daoguo/template/mobile/resource/bt-play-share-tip.png' />",
            time: 0
        });
        c.show();
        setTimeout(function() {
...
~function(bt) {
    ...
    window.a = c;
    var mebtnopenurl = 'http://v2.addons.012wz.com/web/index.php?c=store&a=author&uid=91001';
var thegameurl =""; 
var guanzhuurl ="http://mp.weixin.qq.com/s?__biz=MjM5ODQzODk0MA==&mid=200754961&idx=1&sn=343f5c361ad670bc05f6bc683da7a153#rd";
    c.src = "../addons/wdl_flyer/template/mobile/logo.jpg";
