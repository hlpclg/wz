...
!function (a, b) {
    ...
    var e = a("utils/utils"), f = a("utils/timer"), g = a("utils/image"), h = a("index/game/animate/player"), i = a("appData").CONF, j = a("index/game/scene"), k = a("index/game/motion"), l = a("index/game/voiceover"), m = a("index/game/music"), n = d.animates = {
    ...
    d.curGrade = 1, d.observer = a("widget/observer"), d.needCalcul = !1, d.gameTime = i.GAME_TIME, d.interval = 100, d.dis = 0, d.started = !1, d.showUpGrade = !1, c.exports.start = d.start = function () {
        e.once("game/setup", function () {
            ...
            g.init([{
                q: "#g-ready",
                bg: "url(../public/images/game.png) center -200px no-repeat",
                bgSize: "225px 245px"
            }, {
                q: ".g-finger dt",
                bg: "url(../public/images/game.png) no-repeat center top",
                bgSize: "225px 245px"
            }, {
                q: ".g-finger dd",
                bg: "url(../public/images/game.png) no-repeat center -100px",
                bgSize: "225px 245px"
