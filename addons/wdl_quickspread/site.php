...
require IA_ROOT . '/addons/wdl_quickspread/define.php';
...
class wdl_quickspreadModuleSite extends WechatService {
  private static $t_black = 'wdl_quickspread_blacklist';
  private static $t_qr = 'wdl_quickspread_qr';
  private static $t_follow = 'wdl_quickspread_follow';
  private static $t_credit = 'wdl_quickspread_credit';
  private static $t_channel = 'wdl_quickspread_channel';
  private static $t_active_ch = 'wdl_quickspread_active_channel';
