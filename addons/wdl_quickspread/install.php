...
if (!function_exists("__wdl_quickspread_batch_execute_sql")) {
  function __wdl_quickspread_batch_execute_sql($sqls) {
    global $_W;
...
$sql = "
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_iptable` (
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_blacklist` (
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_user` (
  `from_user` varchar(50) not null default '',
  `weid` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_spread` (
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_fans` (
  `weid`  int(10) unsigned NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_follow` (
  `weid`  int(10) unsigned NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_credit` (
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_active_channel` (
  `weid`  int(10) unsigned NOT NULL,
  `from_user` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_scene_id` (
  `weid`  int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_channel` (
...
CREATE TABLE IF NOT EXISTS `ims_wdl_quickspread_qr` (
  `weid`  int(10) unsigned NOT NULL,
...
__wdl_quickspread_batch_execute_sql($sql);
