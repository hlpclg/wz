...
(function () {
    Ι.ІϺ("camera", "..\/addons\/ewei_takephotoa\/style\/camera.mp3");
    var K = [Ι.get("camera")];
    Sound.JI(K)
}());
var i = i || {};
...
var M = Best.hg.extend({
        ...
        hA: function () {
            ...
            if(!M.cR){
                ...
                var w = "查看排行";
                var Η = 30;
                var m = M.cR =  t.ІJ(180, 100, 30, "rgba(255,255,255,0.8)");
                var Κ1 = m.getContext("2d");
                Κ1.font = Η + "px Heiti";
                Κ1.fillStyle = "rgba(0,0,0,1)";
                var a1 = Κ1.measureText(w);
                Κ1.fillText(w, m.width - a1.width >> 1, m.height + Η >> 1);
            }
            this.cR = M.cR;
        ...
        resize: function () {
            ...
            this.cТR = t.cЕ(this.cR, (this.width - this.cR.width >> 1) + 100, this.height - this.cR.height - 140);
            this.cТF = t.cЕ(this.cFF, (this.width - this.cFF.width >> 1), this.height - this.cFF.height - 20);
        },
        cF: function () {
            this.Β8 = 0;
            this.iΥ = false;
        ...
        PΝ: function (Κ, W, G) {
            ...
            if (this.iΥ) {
                ...
                Κ.drawImage(this.cR, this.cТR[0]  , this.cТR[1] );
            ...
            if (Χ) {
                ...
                if (I < 400) {
                    ...
                    if (a > this.height - 100 && this.Оc) {
                        ...
                        В.v = null;
                        this.AΥ()
                    }else if (this.iΥ && t.PΗ(K, a, this.cТR)) {
                        //排行
