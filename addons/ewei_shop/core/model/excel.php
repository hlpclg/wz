...
class Ewei_DShop_Excel
{
    ...
    function export($list, $params = array())
    {
        ...
        $excel = new PHPExcel();
        $excel->getProperties()->setCreator("折翼天使资源社区")->setLastModifiedBy("折翼天使资源社区")->setTitle("Office 2007 XLSX Test Document")->setSubject("Office 2007 XLSX Test Document")->setDescription("Test document for Office 2007 XLSX, generated using PHP classes.")->setKeywords("office 2007 openxml php")->setCategory("report file");
