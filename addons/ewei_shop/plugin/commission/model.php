...
if (!class_exists('CommissionModel')) {
	class CommissionModel extends PluginModel
	{
		...
		public function calculate($_var_1 = 0, $_var_2 = true)
		{
			...
			$_var_4 = pdo_fetchcolumn('select agentid from ' . tablename('ewei_shop_order') . ' where id=:id limit 1', array(':id' => $_var_1));
			...
			if ($_var_0['level'] > 0) {
				foreach ($_var_5 as &$_var_6) {
					...
					if ($_var_2) {
						...
						pdo_update('ewei_shop_order_goods', array('commission1' => iserializer($_var_6['commission1']), 'commission2' => iserializer($_var_6['commission2']), 'commission3' => iserializer($_var_6['commission3']), 'commissions' => iserializer($_var_9), 'nocommission' => $_var_6['nocommission']), array('id' => $_var_6['id']));
					}
				}
				unset($_var_6);
			}
		...
		public function getOrderCommissions($_var_1 = 0, $_var_16 = 0)
		{
			...
			$_var_0 = $this->getSet();
			$_var_4 = pdo_fetchcolumn('select agentid from ' . tablename('ewei_shop_order') . ' where id=:id limit 1', array(':id' => $_var_1));
			$_var_5 = pdo_fetch('select commission1,commission2,commission3 from ' . tablename('ewei_shop_order_goods') . ' where id=:id and orderid=:orderid and uniacid=:uniacid and nocommission=0 limit 1', array(':id' => $_var_16, ':orderid' => $_var_1, ':uniacid' => $_W['uniacid']));
			$_var_9 = array('level1' => 0, 'level2' => 0, 'level3' => 0);
			if ($_var_0['level'] > 0) {
		...
		public function getInfo($_var_20, $_var_21 = null)
		{
			...
			if ($_var_8 >= 1) {
				if (in_array('ordercount0', $_var_21)) {
					$_var_54 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid=:agentid and o.status>=0 and og.status1>=0 and og.nocommission=0 and o.uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
					$_var_42 += $_var_54['ordercount'];
					$_var_27 += $_var_54['ordercount'];
					$_var_28 += $_var_54['ordermoney'];
				}
				if (in_array('ordercount', $_var_21)) {
					$_var_54 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid=:agentid and o.status>=1 and og.status1>=0 and og.nocommission=0 and o.uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
					$_var_45 += $_var_54['ordercount'];
					$_var_29 += $_var_54['ordercount'];
					$_var_30 += $_var_54['ordermoney'];
				}
				if (in_array('ordercount3', $_var_21)) {
					$_var_55 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid=:agentid and o.status>=3 and og.status1>=0 and og.nocommission=0 and o.uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
				...
				if (in_array('total', $_var_21)) {
					$_var_56 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
				...
				if (in_array('ok', $_var_21)) {
					$_var_56 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . " where o.agentid=:agentid and o.status>=3 and og.nocommission=0 and ({$_var_24} - o.createtime > {$_var_25}) and og.status1=0  and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
					foreach ($_var_56 as $_var_57) {
						$_var_9 = iunserializer($_var_57['commissions']);
						$_var_58 = iunserializer($_var_57['commission1']);
						if (empty($_var_9)) {
				...
				if (in_array('lock', $_var_21)) {
					$_var_59 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . " where o.agentid=:agentid and o.status>=3 and og.nocommission=0 and ({$_var_24} - o.createtime <= {$_var_25})  and og.status1=0  and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
				...
				if (in_array('apply', $_var_21)) {
					$_var_60 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
				...
				if (in_array('check', $_var_21)) {
					$_var_60 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=2 and og.nocommission=0 and o.uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
					foreach ($_var_60 as $_var_57) {
						$_var_9 = iunserializer($_var_57['commissions']);
						$_var_58 = iunserializer($_var_57['commission1']);
						if (empty($_var_9)) {
				...
				if (in_array('pay', $_var_21)) {
					$_var_60 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=3 and og.nocommission=0 and o.uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']));
					foreach ($_var_60 as $_var_57) {
						$_var_9 = iunserializer($_var_57['commissions']);
						$_var_58 = iunserializer($_var_57['commission1']);
						if (empty($_var_9)) {
				...
				$_var_61 = pdo_fetchall('select id from ' . tablename('ewei_shop_member') . ' where agentid=:agentid and isagent=1 and status=1 and uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_22['id']), 'id');
			...
			if ($_var_8 >= 2) {
				if ($_var_39 > 0) {
					if (in_array('ordercount0', $_var_21)) {
						$_var_62 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ')  and o.status>=0 and og.status2>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
						$_var_43 += $_var_62['ordercount'];
						$_var_27 += $_var_62['ordercount'];
						$_var_28 += $_var_62['ordermoney'];
					}
					if (in_array('ordercount', $_var_21)) {
						$_var_62 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ')  and o.status>=1 and og.status2>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
						$_var_46 += $_var_62['ordercount'];
						$_var_29 += $_var_62['ordercount'];
						$_var_30 += $_var_62['ordermoney'];
					}
					if (in_array('ordercount3', $_var_21)) {
						$_var_63 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ')  and o.status>=3 and og.status2>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('total', $_var_21)) {
						$_var_64 = pdo_fetchall('select og.commission2,og.commissions from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ')  and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('ok', $_var_21)) {
						$_var_64 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ")  and ({$_var_24} - o.createtime > {$_var_25}) and o.status>=3 and og.status2=0 and og.nocommission=0  and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid']));
						foreach ($_var_64 as $_var_57) {
							$_var_9 = iunserializer($_var_57['commissions']);
							$_var_58 = iunserializer($_var_57['commission2']);
							if (empty($_var_9)) {
					...
					if (in_array('lock', $_var_21)) {
						$_var_65 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ")  and ({$_var_24} - o.createtime <= {$_var_25}) and og.status2=0 and o.status>=3 and og.nocommission=0 and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('apply', $_var_21)) {
						$_var_66 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ')  and o.status>=3 and og.status2=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('check', $_var_21)) {
						$_var_67 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ')  and o.status>=3 and og.status2=2 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('pay', $_var_21)) {
						$_var_67 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_61)) . ')  and o.status>=3 and og.status2=3 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
						foreach ($_var_67 as $_var_57) {
							$_var_9 = iunserializer($_var_57['commissions']);
							$_var_58 = iunserializer($_var_57['commission2']);
							if (empty($_var_9)) {
					...
					$_var_68 = pdo_fetchall('select id from ' . tablename('ewei_shop_member') . ' where agentid in( ' . implode(',', array_keys($_var_61)) . ') and isagent=1 and status=1 and uniacid=:uniacid', array(':uniacid' => $_W['uniacid']), 'id');
			...
			if ($_var_8 >= 3) {
				if ($_var_40 > 0) {
					if (in_array('ordercount0', $_var_21)) {
						$_var_69 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ')  and o.status>=0 and og.status3>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
						$_var_44 += $_var_69['ordercount'];
						$_var_27 += $_var_69['ordercount'];
						$_var_28 += $_var_69['ordermoney'];
					}
					if (in_array('ordercount', $_var_21)) {
						$_var_69 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ')  and o.status>=1 and og.status3>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
						$_var_47 += $_var_69['ordercount'];
						$_var_29 += $_var_69['ordercount'];
						$_var_30 += $_var_69['ordermoney'];
					}
					if (in_array('ordercount3', $_var_21)) {
						$_var_70 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ')  and o.status>=3 and og.status3>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('total', $_var_21)) {
						$_var_71 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ')  and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('ok', $_var_21)) {
						$_var_71 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ")  and ({$_var_24} - o.createtime > {$_var_25}) and o.status>=3 and og.status3=0  and og.nocommission=0 and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid']));
						foreach ($_var_71 as $_var_57) {
							$_var_9 = iunserializer($_var_57['commissions']);
							$_var_58 = iunserializer($_var_57['commission3']);
							if (empty($_var_9)) {
					...
					if (in_array('lock', $_var_21)) {
						$_var_72 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ")  and o.status>=3 and ({$_var_24} - o.createtime > {$_var_25}) and og.status3=0  and og.nocommission=0 and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('apply', $_var_21)) {
						$_var_73 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ')  and o.status>=3 and og.status3=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('check', $_var_21)) {
						$_var_74 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ')  and o.status>=3 and og.status3=2 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
					...
					if (in_array('pay', $_var_21)) {
						$_var_74 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_68)) . ')  and o.status>=3 and og.status3=3 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
						foreach ($_var_74 as $_var_57) {
							$_var_9 = iunserializer($_var_57['commissions']);
							$_var_58 = iunserializer($_var_57['commission3']);
							if (empty($_var_9)) {
					...
					$_var_75 = pdo_fetchall('select id from ' . tablename('ewei_shop_member') . ' where uniacid=:uniacid and agentid in( ' . implode(',', array_keys($_var_68)) . ') and isagent=1 and status=1', array(':uniacid' => $_W['uniacid']), 'id');
		...
		public function getAgents($_var_1 = 0)
		{
			global $_W, $_GPC;
			$_var_76 = array();
			$_var_77 = pdo_fetch('select id,agentid,openid from ' . tablename('ewei_shop_order') . ' where id=:id and uniacid=:uniacid limit 1', array(':id' => $_var_1, ':uniacid' => $_W['uniacid']));
			if (empty($_var_77)) {
				return $_var_76;
			}
		...
		{
			global $_W;
			$_var_80 = IA_ROOT . '/addons/ewei_shop/data/qrcode/' . $_W['uniacid'];
			if (!is_dir($_var_80)) {
				load()->func('file');
				mkdirs($_var_80);
			}
			$_var_81 = $_W['siteroot'] . 'app/index.php?i=' . $_W['uniacid'] . '&c=entry&m=ewei_shop&do=plugin&p=commission&method=myshop&mid=' . $_var_78;
			if (!empty($_var_79)) {
			...
			return $_W['siteroot'] . 'addons/ewei_shop/data/qrcode/' . $_W['uniacid'] . '/' . $_var_82;
		}
		...
		public function createGoodsImage($_var_5, $_var_85)
		{
			...
			$_var_80 = IA_ROOT . '/addons/ewei_shop/data/poster/' . $_W['uniacid'] . '/';
			if (!is_dir($_var_80)) {
				load()->func('file');
				mkdirs($_var_80);
			}
			...
			if (!is_file($_var_80 . $_var_82)) {
				set_time_limit(0);
				$_var_90 = IA_ROOT . '/addons/ewei_shop/static/fonts/msyh.ttf';
				$_var_91 = imagecreatetruecolor(640, 1225);
				$_var_92 = imagecreatefromjpeg(IA_ROOT . '/addons/ewei_shop/plugin/commission/images/poster.jpg');
			...
			return $_W['siteroot'] . 'addons/ewei_shop/data/poster/' . $_W['uniacid'] . '/' . $_var_82;
		}
		...
		public function checkAgent()
		{
			...
			if ($_var_118) {
				if ($_var_117['openid'] != $_var_20) {
					$_var_119 = pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_commission_clickcount') . ' where uniacid=:uniacid and openid=:openid and from_openid=:from_openid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_20, ':from_openid' => $_var_117['openid']));
					if ($_var_119 <= 0) {
						$_var_120 = array('uniacid' => $_W['uniacid'], 'openid' => $_var_20, 'from_openid' => $_var_117['openid'], 'clicktime' => time());
						pdo_insert('ewei_shop_commission_clickcount', $_var_120);
						pdo_update('ewei_shop_member', array('clickcount' => $_var_117['clickcount'] + 1), array('uniacid' => $_W['uniacid'], 'id' => $_var_117['id']));
					}
				}
			}
			...
			if ($_var_121 == 0) {
				$_var_122 = pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_member') . ' where id<:id and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':id' => $_var_22['id']));
				if ($_var_122 <= 0) {
					pdo_update('ewei_shop_member', array('isagent' => 1, 'status' => 1, 'agenttime' => time(), 'agentblack' => 0), array('uniacid' => $_W['uniacid'], 'id' => $_var_22['id']));
					return;
				}
			}
			$_var_24 = time();
				...
				if ($_var_22['id'] != $_var_117['id']) {
					if (empty($_var_123)) {
						if (empty($_var_22['fixagentid'])) {
							pdo_update('ewei_shop_member', array('agentid' => $_var_117['id'], 'childtime' => $_var_24), array('uniacid' => $_W['uniacid'], 'id' => $_var_22['id']));
						...
						pdo_update('ewei_shop_member', array('inviter' => $_var_117['id']), array('uniacid' => $_W['uniacid'], 'id' => $_var_22['id']));
					}
				}
			}
			...
			if (empty($_var_0['become'])) {
				if (empty($_var_22['agentblack'])) {
					pdo_update('ewei_shop_member', array('isagent' => 1, 'status' => $_var_124, 'agenttime' => $_var_124 == 1 ? $_var_24 : 0), array('uniacid' => $_W['uniacid'], 'id' => $_var_22['id']));
					if ($_var_124 == 1) {
		...
		public function checkOrderConfirm($_var_1 = '0')
		{
			...
			$_var_77 = pdo_fetch('select id,openid,ordersn,goodsprice,agentid,paytime from ' . tablename('ewei_shop_order') . ' where id=:id and status>=0 and uniacid=:uniacid limit 1', array(':id' => $_var_1, ':uniacid' => $_W['uniacid']));
			if (empty($_var_77)) {
				return;
			}
			...
			if (!empty($_var_4)) {
				pdo_update('ewei_shop_order', array('agentid' => $_var_4), array('id' => $_var_1));
			}
		...
		public function checkOrderPay($_var_1 = '0')
		{
			...
			$_var_77 = pdo_fetch('select id,openid,ordersn,goodsprice,agentid,paytime from ' . tablename('ewei_shop_order') . ' where id=:id and status>=1 and uniacid=:uniacid limit 1', array(':id' => $_var_1, ':uniacid' => $_W['uniacid']));
			if (empty($_var_77)) {
				return;
			}
			$_var_20 = $_var_77['openid'];
					...
					if (empty($_var_22['agentid']) && $_var_22['id'] != $_var_117['id']) {
						if (empty($_var_22['fixagentid'])) {
							...
							if (empty($_var_77['agentid'])) {
								...
								pdo_update('ewei_shop_order', array('agentid' => $_var_117['id']), array('id' => $_var_1));
								$this->calculate($_var_1);
							}
						}
					}
			...
			if (!$_var_125 && empty($_var_0['become_order'])) {
				...
				if ($_var_0['become'] == 2 || $_var_0['become'] == 3) {
					...
					if ($_var_126) {
						$_var_127 = false;
						if ($_var_0['become'] == '2') {
							$_var_29 = pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_order') . ' where openid=:openid and status>=1 and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_20));
							$_var_127 = $_var_29 >= intval($_var_0['become_ordercount']);
						} else if ($_var_0['become'] == '3') {
							$_var_128 = pdo_fetchcolumn('select sum(og.realprice) from ' . tablename('ewei_shop_order_goods') . ' og left join ' . tablename('ewei_shop_order') . ' o on og.orderid=o.id  where o.openid=:openid and o.status>=1 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_20));
							$_var_127 = $_var_128 >= floatval($_var_0['become_moneycount']);
						}
						if ($_var_127) {
							if (empty($_var_22['agentblack'])) {
								$_var_124 = intval($_var_0['become_check']);
								pdo_update('ewei_shop_member', array('status' => $_var_124, 'isagent' => 1, 'agenttime' => $_var_24), array('uniacid' => $_W['uniacid'], 'id' => $_var_22['id']));
								if ($_var_124 == 1) {
									$this->sendMessage($_var_20, array('nickname' => $_var_22['nickname'], 'agenttime' => $_var_24), TM_COMMISSION_BECOME);
									if ($_var_126) {
										$this->upgradeLevelByAgent($_var_117['id']);
			...
			if (!empty($_var_22['agentid'])) {
				...
				if (!empty($_var_117) && $_var_117['isagent'] == 1 && $_var_117['status'] == 1) {
					if ($_var_77['agentid'] == $_var_117['id']) {
						$_var_129 = pdo_fetchall('select g.id,g.title,og.total,og.price,og.realprice, og.optionname as optiontitle,g.noticeopenid,g.noticetype,og.commission1 from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join ' . tablename('ewei_shop_goods') . ' g on g.id=og.goodsid ' . ' where og.uniacid=:uniacid and og.orderid=:orderid ', array(':uniacid' => $_W['uniacid'], ':orderid' => $_var_77['id']));
						$_var_5 = '';
		...
		public function checkOrderFinish($_var_1 = '')
		{
			...
			$_var_77 = pdo_fetch('select id,openid, ordersn,goodsprice,agentid,finishtime from ' . tablename('ewei_shop_order') . ' where id=:id and status>=3 and uniacid=:uniacid limit 1', array(':id' => $_var_1, ':uniacid' => $_W['uniacid']));
			if (empty($_var_77)) {
				return;
			}
			$_var_0 = $this->getSet();
			...
			if (!$_var_125 && $_var_0['become_order'] == 1) {
				if ($_var_0['become'] == 2 || $_var_0['become'] == 3) {
					...
					if ($_var_126) {
						$_var_127 = false;
						if ($_var_0['become'] == '2') {
							$_var_29 = pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_order') . ' where openid=:openid and status>=3 and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_20));
							$_var_127 = $_var_29 >= intval($_var_0['become_ordercount']);
						} else if ($_var_0['become'] == '3') {
							$_var_128 = pdo_fetchcolumn('select sum(goodsprice) from ' . tablename('ewei_shop_order') . ' where openid=:openid and status>=3 and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_20));
							$_var_127 = $_var_128 >= floatval($_var_0['become_moneycount']);
						}
						if ($_var_127) {
							if (empty($_var_22['agentblack'])) {
			...
			if (!empty($_var_22['agentid'])) {
				...
				if (!empty($_var_117) && $_var_117['isagent'] == 1 && $_var_117['status'] == 1) {
					if ($_var_77['agentid'] == $_var_117['id']) {
						$_var_129 = pdo_fetchall('select g.id,g.title,og.total,og.realprice,og.price,og.optionname as optiontitle,g.noticeopenid,g.noticetype,og.commission1 from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join ' . tablename('ewei_shop_goods') . ' g on g.id=og.goodsid ' . ' where og.uniacid=:uniacid and og.orderid=:orderid ', array(':uniacid' => $_W['uniacid'], ':orderid' => $_var_77['id']));
						$_var_5 = '';
						$_var_8 = $_var_117['agentlevel'];
						$_var_33 = 0;
						$_var_130 = 0;
		...
		function getShop($_var_132)
		{
			...
			$_var_133 = pdo_fetch('select * from ' . tablename('ewei_shop_commission_shop') . ' where uniacid=:uniacid and mid=:mid limit 1', array(':uniacid' => $_W['uniacid'], ':mid' => $_var_22['id']));
		...
		function getLevel($_var_20)
		{
			...
			$_var_8 = pdo_fetch('select * from ' . tablename('ewei_shop_commission_level') . ' where uniacid=:uniacid and id=:id limit 1', array(':uniacid' => $_W['uniacid'], ':id' => $_var_22['agentlevel']));
			return $_var_8;
		}
		...
		function upgradeLevelByOrder($_var_20)
		{
			...
			if ($_var_139 == 4 || $_var_139 == 5) {
				...
				$_var_141 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('ewei_shop_order') . ' o ' . ' left join  ' . tablename('ewei_shop_order_goods') . ' og on og.orderid=o.id ' . ' where o.openid=:openid and o.status>=3 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_20));
				$_var_30 = $_var_141['ordermoney'];
				$_var_29 = $_var_141['ordercount'];
				if ($_var_139 == 4) {
					$_var_142 = pdo_fetch('select * from ' . tablename('ewei_shop_commission_level') . " where uniacid=:uniacid  and {$_var_30} >= ordermoney and ordermoney>0  order by ordermoney desc limit 1", array(':uniacid' => $_W['uniacid']));
					if (empty($_var_142)) {
						return;
					}
					if (!empty($_var_140['id'])) {
					...
					$_var_142 = pdo_fetch('select * from ' . tablename('ewei_shop_commission_level') . " where uniacid=:uniacid  and {$_var_29} >= ordercount and ordercount>0  order by ordercount desc limit 1", array(':uniacid' => $_W['uniacid']));
					if (empty($_var_142)) {
						return;
					}
					if (!empty($_var_140['id'])) {
				...
				pdo_update('ewei_shop_member', array('agentlevel' => $_var_142['id']), array('id' => $_var_132['id']));
				...
				foreach ($_var_76 as $_var_143) {
					...
					pdo_update('ewei_shop_member', array('agentlevel' => $_var_142['id']), array('id' => $_var_143['id']));
		...
		function upgradeLevelByAgent($_var_20)
		{
			...
			if ($_var_139 == 6 || $_var_139 == 8) {
				...
				foreach ($_var_76 as $_var_143) {
					...
					if ($_var_139 == 6) {
						$_var_145 = pdo_fetchall('select id from ' . tablename('ewei_shop_member') . ' where agentid=:agentid and uniacid=:uniacid ', array(':agentid' => $_var_132['id'], ':uniacid' => $_W['uniacid']), 'id');
						$_var_146 += count($_var_145);
						if (!empty($_var_145)) {
							$_var_147 = pdo_fetchall('select id from ' . tablename('ewei_shop_member') . ' where agentid in( ' . implode(',', array_keys($_var_145)) . ') and uniacid=:uniacid', array(':uniacid' => $_W['uniacid']), 'id');
							$_var_146 += count($_var_147);
							if (!empty($_var_147)) {
								$_var_148 = pdo_fetchall('select id from ' . tablename('ewei_shop_member') . ' where agentid in( ' . implode(',', array_keys($_var_147)) . ') and uniacid=:uniacid', array(':uniacid' => $_W['uniacid']), 'id');
								$_var_146 += count($_var_148);
							}
						}
						$_var_142 = pdo_fetch('select * from ' . tablename('ewei_shop_commission_level') . " where uniacid=:uniacid  and {$_var_146} >= downcount and downcount>0  order by downcount desc limit 1", array(':uniacid' => $_W['uniacid']));
					} else if ($_var_139 == 8) {
				...
				if ($_var_139 == 7) {
					$_var_146 = pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_member') . ' where agentid=:agentid and uniacid=:uniacid ', array(':agentid' => $_var_132['id'], ':uniacid' => $_W['uniacid']));
					$_var_142 = pdo_fetch('select * from ' . tablename('ewei_shop_commission_level') . " where uniacid=:uniacid  and {$_var_146} >= downcount and downcount>0  order by downcount desc limit 1", array(':uniacid' => $_W['uniacid']));
				} else if ($_var_139 == 9) {
		...
		function upgradeLevelByCommissionOK($_var_20)
		{
			...
			$_var_142 = pdo_fetch('select * from ' . tablename('ewei_shop_commission_level') . " where uniacid=:uniacid  and {$_var_149} >= commissionmoney and commissionmoney>0  order by commissionmoney desc limit 1", array(':uniacid' => $_W['uniacid']));
			if (empty($_var_142)) {
				return;
			}
			if ($_var_140['id'] == $_var_142['id']) {
