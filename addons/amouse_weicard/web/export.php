...
$weid=$_W['uniacid'];
$result = pdo_fetchAll("SELECT * FROM ".tablename('amouse_weicard2_fans')." WHERE  weid=".$weid." ORDER BY id DESC ");
$title= "名字".","."部门".","."职务".","."公司".","."电话".","."时间"."\n";
...
if(isWin()){
	...
	foreach ($result as $key => $value) {
        ...
        .",".$value['job']
        .",".$value['company']
		.",".$value['mobile'].",".date("Y-m-d G:i",$value['createtime'])."\n";
