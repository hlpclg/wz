 ...
 * ajax提交str数据
 * @param url 地址
 * @param jsobject js一维对�?
 * @param successfun 成功回调 回调信息类型依据后台返回而定 如果为write_json则为json格式 否则是文本格�?
 * @param errorfun 失败回调
 */
