...
{
	res: [
	{id:"begin", size:372, src:"../addons/wdl_houzi/template/mobile/images/0begin.png"},
    {id:"end", size:372, src:"../addons/wdl_houzi/template/mobile/images/1end.png"},
    {id:"help", size:372, src:"../addons/wdl_houzi/template/mobile/images/2help.png"},
	{id:"btns", size:77, src:"../addons/wdl_houzi/template/mobile/images/btns.png"},
    {id:"endbtns", size:151, src:"../addons/wdl_houzi/template/mobile/images/endbtns.png"},
    {id:"helpbtns", size:151, src:"../addons/wdl_houzi/template/mobile/images/helpbtns.png"},
    {id:"yxgzbtns", size:151, src:"../addons/wdl_houzi/template/mobile/images/yxgzbtns.png"},
	{id:"monkey", size:186, src:"../addons/wdl_houzi/template/mobile/images/monkey.png"},
	{id:"peach", size:151, src:"../addons/wdl_houzi/template/mobile/images/peach.png"},
	{id:"island", size:372, src:"../addons/wdl_houzi/template/mobile/images/island.png"},
	{id:"num1", size:15, src:"../addons/wdl_houzi/template/mobile/images/num1.png"},
	{id:"num2", size:29, src:"../addons/wdl_houzi/template/mobile/images/num2.png"}
	],
...
game.startup = function()
{
  ...
  //  this.fps = this.params.fps || 40;
	...
	//预加载背景音乐
   // var audio = new Quark.Audio("../addons/wdl_houzi/template/mobile/images/a.mp3", true, true, true);
   // this.audio = audio;
