...
~function(bt) {
    ...
    var loading = function(d, e) {
        if (d > 0 && !b) {
            ...
            b.html('<table><tr><td><img class="bt-img" src="../addons/guess_girl/template/mobile/resource/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
~function(bt) {
    ...
    onlyH.prototype = {
        ...
        getScreenOption: function() {
            return {
                id: "bt-h-scrren",
                html: "<table><tr><td><img class='bt-h-screen-img' src='../addons/guess_girl/template/mobile/resource//bt-play-h-screen.png' /></td></tr></table>",
                time: 0,
                lockId: "bt-hide-lock"
            };
        },
    ...
    onlyV.prototype = $.extend({}, onlyH.prototype, {
        ...
        getScreenOption: function() {
            return {
                id: "bt-v-scrren",
                html: "<table><tr><td><img class='bt-v-screen-img' src='../addons/guess_girl/template/mobile/resource/bt-play-v-screen.png' /></td></tr></table>",
                time: 0,
                lockId: "bt-hide-lock"
            };
        }
...
~function(bt) {
    ...
    function tip() {
        var c = bt.advertisement({
            id: b,
            html: "<img class='bt-play-share-tip-img' src='../addons/guess_girl/template/mobile/resource/bt-play-share-tip.png' />",
            time: 0
        });
        c.show();
        setTimeout(function() {
...
~function(bt) {
    ...
    window.a = c;
    var mebtnopenurl = 'http://www.weixin199.com/youxi';
var thegameurl =""; 
