...
$tableheader = array($this->encode("openid",$dc), $this->encode("昵称",$dc),$this->encode("姓名",$dc),$this->encode("手机号",$dc),$this->encode('点数',$dc ),$this->encode('助力次数',$dc ),$this->encode('IP',$dc),$this->encode('参与时间',$dc ));
$html = "\xEF\xBB\xBF";
...
foreach ($list as $value) {
	...
	$html .= $this->encode( $value['poiint'],$dc )  . "\t ,";
