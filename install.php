...
if($action == 'env') {
	...
	if(version_compare(PHP_VERSION, '5.3.0') == -1) {
		...
		$ret['php']['version']['remark'] = 'PHP版本必须为 5.3.0 以上. <a href="http://j0515.com/">详情</a>';
	}
	...
	if($ispost) {
		...
		if(empty($error)) {
			...
			if($_POST['type'] == 'remote') {
				...
				if($ins['error']) {
					die('<script type="text/javascript">alert("链接捌零更新服务器失败, 错误为: ' . $ins['error'] . '！");history.back();</script>');
				}
				$archive = $ins['files'];
				if(!$archive) {
...
VER;
			...
			if(file_exists(IA_ROOT . '/index.php') && is_dir(IA_ROOT . '/app') && is_dir(IA_ROOT . '/web') && file_exists($verfile) && file_exists($dbfile)) {
				...
				die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从捌零官网下载完整安装包后重试.");history.back();</script>');
			}
...
<html lang="zh-cn">
	<head>
		...
		<title>安装系统 - 捌零 - 公众平台自助开源引擎</title>
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">安装捌零系统</a></li>
					<li role="presentation"><a href="http://www.j0515.com">捌零官网</a></li>
					<li role="presentation"><a href="http://j0515.com">访问论坛</a></li>
				</ul>
				<img src="http://ss.j0515.com/attachment/images/global/P6gO7WFpZvrn7XewjOXRfp7WvxJ6gF.png" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.j0515.com">关于捌零</a> &nbsp; &nbsp; <a href="http://j0515.com">捌零帮助</a> &nbsp; &nbsp; <a href="http://www.j0515.com">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="http://www.j0515.com"><b>捌零</b></a> v0.6 &copy; 2014 <a href="http://www.j0515.com">www.j0515.com</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014-2015，捌零团队保留所有权利。 </h3>
				<p>
					感谢您选择捌零 - 微信公众平台自助开源引擎（以下简称WEIZAN，WEIZAN基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于捌零系统(以下简称捌零)任何版本，捌零官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改捌零源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在捌零的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
function tpl_install_env($ret = array()) {
	...
	echo <<<EOF
		...
		<div class="alert alert-info">系统要求捌零整个安装目录必须可写, 才能使用捌零所有功能。</div>
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="help-block">
							在线安装能够直接安装最新版本捌零系统, 如果在线安装困难, 请下载离线安装包后使用本地安装. <br/>
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“捌零 - 公众平台自助开源引擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
		<br />
	</div>
	<div class="alert alert-warning">
		我们强烈建议您立即注册云服务，享受“在线更新”等云服务。<a target="_blank" class="btn btn-success" href="http://ss.j0515.com">马上去注册</a>
		<br />
	</div>
EOF;
	tpl_frame();
...
function tpl_resources() {
	static $res = array(
		'logo' => 'http://ss.j0515.com/attachment/images/global/P6gO7WFpZvrn7XewjOXRfp7WvxJ6gF.png',
	);
	return $res;
}
