...
<div class="login">
				...
				<form action="" method="post" role="form" onsubmit="return formcheck();">
					...
					<div class="form-group">
						<label class="checkbox-inline input-lg">
							<input type="checkbox" value="true" name="rember"> 记住用户名 <font color="red">[请点‘注册’,体验新马泰-微信功能服务！]</font>
						</label>
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.j0515.com">新马泰文化</a>&nbsp;&nbsp;<a href="http://j0515.com">新马泰论坛</a>&nbsp;&nbsp;<a href="/">联系客服QQ2316571101</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.j0515.com"><b>新马泰</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.j0515.com">www.j0515.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
		</div>
	</div>
</div>
<script>
