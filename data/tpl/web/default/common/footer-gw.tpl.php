<?php defined('IN_IA') or exit('Access Denied');?>			</div>
		...
		<div class="center-block footer" role="footer">
			<div class="text-center">
				<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.j0515.com">新马泰文化</a>&nbsp;&nbsp;<a href="http://j0515.com">新马泰帮助</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?><?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?>&nbsp; &nbsp; <?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
			</div>
			<div class="text-center">
				<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.j0515.com"><b>新马泰</b></a> v<?php echo IMS_VERSION;?> &copy; 2014 <a href="http://www.j0515.com">www.j0515.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
			</div>
		</div>
	</div>
