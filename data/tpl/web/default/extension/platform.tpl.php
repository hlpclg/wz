	...
	<div class="clearfix">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<label class="radio-inline"><input  type="radio" name="authstate"  value="1" <?php  if($_W['setting']['platform']['authstate']) { ?> checked<?php  } ?> > 是</label>
				<label class="radio-inline"><input  type="radio" name="authstate"  value="0" <?php  if(!$_W['setting']['platform']['authstate']) { ?> checked<?php  } ?> > 否</label>
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require"> </span>测试登陆授权</label>
			<div class="col-sm-9 col-xs-12">
				<a id="auth" href="<?php  echo $authurl;?>"><img src="https://open.weixin.qq.com/zh_CN/htmledition/res/assets/res-design-download/icon_button3_2.png" /></a>
			</div>
		</div>
		<div class="form-group">
